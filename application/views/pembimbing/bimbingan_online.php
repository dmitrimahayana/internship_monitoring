    ...
    <div class="row">
        ...
        <div class="span12" style="padding-top: 30px;">
            ...
            <div id="my-tab-content" class="tab-content">
                <h1>Bimbingan Online Kelompok KLP<?php echo $idklp; ?></h1>
                <!--form action="" method="post" enctype="multipart/form-data"-->
                    <?php $data['idklp'] = $idklp; $this->load->view('pembimbing/modalBimbingan',$data); ?>
                <table style="width: 80%;">
                    <tr>
                        <td>
                            <a href="#myModalBimbingan" role="button" class="btn btn-primary" data-toggle="modal">Buat Baru Bimbingan</a>

                            <a href="<?php echo base_url().'pembimbing/show/beranda' ?>" class="btn btn-danger pull-right">Back to Previous Page</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div id="accordion">
                                ...
                                <div>
                                    ...
                                    <hr>
                                    <?php }}?>
                                    <?php //if($dateNow==$bimbingan->TANGGAL_BIMBINGAN){?>
                                    <form action="<?php echo base_url();?>pembimbing/insert/catatanBimbingan" method="post" enctype="multipart/form-data">
