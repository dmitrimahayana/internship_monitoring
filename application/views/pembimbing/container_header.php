    ...
    <div class="navbar-inner">
      <div class="container">
        ...
        <div class="nav-collapse collapse" style="padding-top: 20px;">
            <ul class="nav">
                <li style="margin-left: 10px;" class="active"><?php if(isset($username)){ ?><a href="<?php echo base_url(); ?>pembimbing/show/beranda">Home</a><?php } else { ?><a href="<?php echo base_url(); ?>home/view/home">Home</a><?php } ?></li>
